 ...
 ?>
  <form action="" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label for="course_id">Service ID</label>
    ...
    <div class="form-group">
      <label for="course_duration">Service Duration</label>
    ...
    <div class="form-group">
      <label for="course_original_price">Service Original Price</label>
    ...
    <div class="form-group">
      <label for="course_price">Service Selling Price</label>
    ...
    <div class="form-group">
      <label for="course_img">Service Image</label>
