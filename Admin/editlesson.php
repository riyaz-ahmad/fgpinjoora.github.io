...
define('TITLE', 'Edit Sub-Services');
define('PAGE', 'lessons');
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Update Sub-Services Details</h3>
  <?php
 ...
 ?>
  <form action="" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      <label for="lesson_id">Sub-Services ID</label>
    ...
    <div class="form-group">
      <label for="lesson_name">Sub-Services Name</label>
    ...
    <div class="form-group">
      <label for="lesson_desc">Sub-Services Description</label>
    ...
    <div class="form-group">
      <label for="course_id">Sub-Services ID</label>
    ...
    <div class="form-group">
      <label for="course_name">Sub-Services Name</label>
    ...
    <div class="form-group">
      <label for="lesson_link">Sub-Services Link</label>
