...
<html lang="en">
  <head>
    ...
    <title>FG-Pinjoora</title>
  </head>
  <body>
     <!-- Start Nagigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">Friend's Gallery</a>
      <span class="navbar-text">Pinjoora</span>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item"><a href="courses.php" class="nav-link">Services</a></li>
          <li class="nav-item custom-nav-item"><a href="paymentstatus.php" class="nav-link">Request Status</a></li>
          <?php 
              session_start();   
          ...
          <li class="nav-item custom-nav-item"><a target="_blank" href="https://forms.gle/rMFyZhoC3WJXGZw5A" id="blink"class="nav-link">Book Slot</a></li>
        </ul>
      </div>
    </nav> <!-- End Navigation -->